...
let ParseJsonPipe = class ParseJsonPipe {
    async transform(value, { metatype }) {
        ...
        try {
            ...
            const objects = (0, class_transformer_1.plainToInstance)(metatype, parsed);
            const errors = await (0, class_validator_1.validate)(objects);
            if (errors.length > 0) {
                throw new common_1.BadRequestException('Validation failed');
            }
            return objects;
...
//# sourceMappingURL=parsejson.pipe.js.map